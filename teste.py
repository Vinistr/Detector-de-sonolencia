...
vs = FileVideoStream("C:/Users/vinicius.sartore/Documents/TCC/drowsiness-detection/drowsiness-detection/videos/teste1.mp4").start()
fileStream = True
time.sleep(1.0)

SHOWCASE_DATA=pd.read_csv("C:/Users/vinicius.sartore/Documents/TCC/Eye-blinking-SVM-master/Eye-blinking-SVM-master/prevision/data_final_Bianca.csv", index_col="frame")
